  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Color(0xFFFEAF09),
        actions: <Widget>[
...
class BarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (this.value < 500 * .10) {
      paint.color = Color(0xFFC8F9F1);
    } else if (this.value < 500 * .20) {
      paint.color = Color(0xFF98F9E9);
    } else if (this.value < 500 * .30) {
      paint.color = Color(0xFF69F6DF);
    } else if (this.value < 500 * .40) {
      paint.color = Color(0xFF3AE0C5);
    } else if (this.value < 500 * .50) {
      paint.color = Color(0xFF15D4B5);
    } else if (this.value < 500 * .60) {
      paint.color = Color(0xFF0EAB92);
    } else if (this.value < 500 * .70) {
      paint.color = Color(0xFF0B7C6A);
    } else if (this.value < 500 * .80) {
      paint.color = Color(0xFF095246);
    } else if (this.value < 500 * .90) {
      paint.color = Color(0xFF09433B);
    } else {
      paint.color = Color(0xFF052823);
    }
